...
class T301MultiDocumentFusionUnified:
    ...
    def get_contract(self) -> 'ToolContract':
        """Return tool contract for WorkflowAgent compatibility."""
        from src.tools.base_tool import ToolContract
        
        return ToolContract(
            tool_id=self.tool_id,
            name="Multi-Document Fusion Tool",
            description="Advanced multi-document knowledge fusion with conflict resolution and quality assessment using modular architecture",
            category="fusion",
            input_schema={
                "type": "object",
                "properties": {
                    ...
                    "fusion_strategy": {
                        "type": "string",
                        "enum": ["evidence_based", "confidence_weighted", "temporal"],
            ...
            output_schema={
                ...
                "properties": {
                    ...
                    "entities_before_fusion": {"type": "integer"},
                    "entities_after_fusion": {"type": "integer"},
                    "relationships_before_fusion": {"type": "integer"},
                    "relationships_after_fusion": {"type": "integer"},
                    "conflicts_resolved": {"type": "integer"},
                    "consistency_score": {"type": "number"},
                    "fusion_time_seconds": {"type": "number"},
                    "evidence_chains": {"type": "array"},
                    "duplicate_clusters": {"type": "array"},
                    "warnings": {"type": "array"}
                }
            },
            dependencies=["identity_service", "quality_service", "llm_service"],
