...
class RecoveryStrategy(Enum):
    """Recovery strategies for different error types - FAIL-FAST ARCHITECTURE"""
    RETRY = "retry"
    CIRCUIT_BREAKER = "circuit_breaker"
    ABORT_AND_ALERT = "abort_and_alert"
    ESCALATE = "escalate"
    # REMOVED: FALLBACK and GRACEFUL_DEGRADATION - not compatible with fail-fast philosophy
