"""
Unit tests for T23A spaCy NER with unified interface - NO MOCKS VERSION.
...
class TestT23ASpacyNERUnifiedReal:
    """Test suite for T23A spaCy NER with REAL functionality - NO MOCKS"""
