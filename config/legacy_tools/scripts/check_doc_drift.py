...
def check_schema_version_consistency():
    """Check that all schema references use v13"""
    ...
    v13_pattern = re.compile(r'config/schemas/theory_meta_schema_v13\.json')
    ...
    for md_file in docs_dir.rglob("*.md"):
        ...
        # Check for v13 references
        if not v13_pattern.search(content) and "schema" in content.lower():
            issues.append(f"⚠️  {md_file}: May need v13 schema reference")
