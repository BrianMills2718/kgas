...
async def create_persistent_data():
    ...
    # Setup Neo4j (using environment variable for password)
    import os
    neo4j_password = os.getenv("NEO4J_PASSWORD", "testpassword")  # fallback for dev
    ...
    print("2. Login with username: neo4j, password: (set NEO4J_PASSWORD env var)")
