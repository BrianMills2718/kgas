#!/usr/bin/env python3
"""
Run Core Architecture Analysis using Gemini
"""
...
def read_validation_config():
    """Read the core architecture validation config"""
    import yaml
    config_path = Path(__file__).parent / "core-architecture.yaml"
    with open(config_path, 'r') as f:
        return yaml.safe_load(f)

def read_bundle():
    """Read the repomix bundle"""
    bundle_path = Path(__file__).parent / "bundles" / "core-architecture.xml"
...
def save_results(analysis, config):
    ...
    # Save the analysis
    analysis_file = results_dir / "core-architecture-analysis.md"
    with open(analysis_file, 'w', encoding='utf-8') as f:
        f.write(f"# Core Architecture Analysis\n\n")
...
def main():
    """Run the core architecture analysis"""
    print("🏗️  Running Core Architecture Analysis")
    print("=" * 50)
