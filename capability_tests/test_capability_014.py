#!/usr/bin/env python3
"""
TEST FILE FOR CAPABILITY 014
Capability: TextChunker.get_tool_info()
...
def test_capability_014():
    """Test Capability 014: TextChunker.get_tool_info()"""
    
    test_start_time = time.time()
    result = {
        "capability_id": 14,
        "capability_name": "TextChunker.get_tool_info()",
        "test_type": "method",
        "description": "Return tool metadata and capabilities",
    ...
    try:
        print(f"🧪 TESTING CAPABILITY 014: TextChunker.get_tool_info()")
...
def main():
    ...
    result = test_capability_014()
    
    # Save result to log file
    log_file = f"capability_014_test_log.txt"
    
    with open(log_file, 'w') as f:
        f.write(f"CAPABILITY 014 TEST LOG\n")
        f.write("=" * 50 + "\n")
        f.write(f"Capability: TextChunker.get_tool_info()\n")
