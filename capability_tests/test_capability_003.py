#!/usr/bin/env python3
"""
TEST FILE FOR CAPABILITY 003
Capability: PDFLoader.get_supported_formats()
...
def test_capability_003():
    """Test Capability 003: PDFLoader.get_supported_formats()"""
    
    test_start_time = time.time()
    result = {
        "capability_id": 3,
        "capability_name": "PDFLoader.get_supported_formats()",
        "test_type": "method",
        "description": "Return list of supported file formats",
        "file_path": "src/tools/phase1/t01_pdf_loader.py",
        "class_name": "PDFLoader",
        "method_name": "get_supported_formats",
    ...
    try:
        print(f"🧪 TESTING CAPABILITY 003: PDFLoader.get_supported_formats()")
        print(f"📁 File: src/tools/phase1/t01_pdf_loader.py")
        print(f"🏗️  Class: PDFLoader")
        print(f"⚙️  Method: get_supported_formats")
        print(f"📝 Description: Return list of supported file formats")
        print("-" * 80)
...
def main():
    ...
    result = test_capability_003()
    
    # Save result to log file
    log_file = f"capability_003_test_log.txt"
    
    with open(log_file, 'w') as f:
        f.write(f"CAPABILITY 003 TEST LOG\n")
        f.write("=" * 50 + "\n")
        f.write(f"Capability: PDFLoader.get_supported_formats()\n")
        f.write(f"Description: Return list of supported file formats\n")
        f.write(f"File: src/tools/phase1/t01_pdf_loader.py\n")
        f.write(f"Class: PDFLoader\n")
        f.write(f"Method: get_supported_formats\n")
